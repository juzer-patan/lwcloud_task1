...
resource "null_resource" "local1" {
    ...
    command = "git clone https://github.com/juzer-patan/lwcloud_task1.git C:/Users/juzer/Desktop/githubjpg"
  }
}
...
resource "aws_s3_bucket_object" "object" {
  bucket = aws_s3_bucket.terrab.id
  key    = "jpatan.jpg"
  source = "C:/Users/juzer/Desktop/githubjpg/jpatan.jpg"
...
//Use the provisioner "remote-exec" to mount and format the ebs volume and clone the github code
